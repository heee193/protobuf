...
fn mutate_message_in_cpp() {
    ...
    msg2.optional_int64_set(42);
    msg2.optional_bytes_set(b"something mysterious");
    msg2.optional_bool_set(false);
...
fn deserialize_in_rust() {
    let mut msg1 = TestAllTypes::new();
    msg1.optional_int64_set(-1);
    msg1.optional_bytes_set(b"some cool data I guess");
